/**********************************************************************************/
/***	Scenario B (U influences stroke and mortality) search loop 	    	***/
/***	program.								***/
/***	This program searches for baseline mortality hazards FROM BIRTH		***/
/***	for exp=0 and exp=1 to line up with US Life Tables. 			***/
/***	The search loop is needed because U influences mortality FROM BIRTH	***/
/***	and also because stroke kills people: pstrokedeath die at stroke 	***/
/***	and g4 for effect of stroke history on death.				***/
...
/***	of death for ages 45+ because stroke (which is higher in blacks) 	***/
/***	kills people.								***/
/**********************************************************************************/
set more off
...
/*baseline hazard of mortality to be identified from search loop
...
*Target values
global target_p_death0to1_exp0 = 0.0722 
global target_p_death1to5_exp0 = 0.0324
global target_p_death5to10_exp0 = 0.0138
global target_p_death10to15_exp0 = 0.0102
global target_p_death15to20_exp0 = 0.0168
global target_p_death20to25_exp0 = 0.0238
global target_p_death25to30_exp0 = 0.0276
global target_p_death30to35_exp0 = 0.0307
global target_p_death35to40_exp0 = 0.0332
global target_p_death40to45_exp0 = 0.0383
...
*Starting values
global lambda_0to1l = 0
global lambda_1to5l = 0
global lambda_5to10l = 0
global lambda_10to15l = 0	
global lambda_15to20l = 0	
global lambda_20to25l = 0
global lambda_25to30l = 0
global lambda_30to35l = 0
global lambda_35to40l = 0
global lambda_40to45l = 0
...
/***************************************************************************************************************/
/***************************************************************************************************************/
/***		Search loops for baseline mortality hazard for whites ages 0-95								 ***/
...
/******************************************************************************/
/***		Find baseline MORTALITY hazard for whites age 0-1	    ***/
/******************************************************************************/
clear
...
forvalues i=1/5 {
   clear
   local toolow =1
   local target_p_death0to1_exp0 = $target_p_death0to1_exp0
   *add lower bound guess here
   local lambda_0to1l = $lambda_0to1l
   quietly forvalues x = 0(.001)30 { //0(.0001)30 {
      if `toolow'==1 {
         local seed = 8675309 + `i'
		 set seed `seed'
         local lambda_0to1lt =`lambda_0to1l'+`x'
         noisily dis "***next increment***"
         noisily dis "increment = " `x'
         noisily di in green "lambda_0to1 = `lambda_0to1lt'"
         clear
		 /*Create blank data set*/
			...
			*Generate survival time from time 0
			gen survtime0to1 = -ln(U_0to1)/(`lambda_0to1lt'*exp(`g1_0to1'*exposure +`g2'*U ///
		 ...
		 qui sum death0to1 if (exposure==0)
		 local p_death0to1_exp0 = r(mean) 
         if `p_death0to1_exp0' > `target_p_death0to1_exp0'+.0001 {
            local toolow=0
            noisily di in red "I stopped at lambda_0to1==`lambda_0to1lt', p_death0to1_exp0=`p_death0to1_exp0'
         }
         else {
            noisily di in white "I did NOT stop at lambda_0to1==`lambda_0to1lt', p_death0to1_exp0=`p_death0to1_exp0'
         }
      }
   }
   local lambda_0to1`i' = `lambda_0to1lt'
}
clear
set obs 5
gen lambda_0to1=.
forvalues i=1/5 {
   replace lambda_0to1=`lambda_0to1`i'' in `i'
}
sum lambda_0to1
global lambda_0to1 = `r(mean)'
global lambda_0to1_min = `r(min)'
global lambda_0to1_max = `r(max)'


/******************************************************************************/
/***		Find baseline MORTALITY hazard for whites age 1-5	    ***/  
/******************************************************************************/
clear
...
forvalues i=1/5 {
   clear
   local toolow =1
   local target_p_death1to5_exp0 = $target_p_death1to5_exp0
   *add lower bound guess here
   local lambda_1to5l = $lambda_1to5l
   quietly forvalues x = 0(.001)30 { //0(.0001)30 {
      if `toolow'==1 {
         local seed = 8675309 + `i'
		 set seed `seed'
         local lambda_1to5lt =`lambda_1to5l'+`x'
         noisily dis "***next increment***"
         noisily dis "increment = " `x'
         noisily di in green "lambda_1to5 = `lambda_1to5lt'"
         clear
		 /*Create blank data set*/
			set obs 20000 //creates blank dataset with XXXXX observations
			gen id = _n
			...
			*Generate survival time from time 1
			gen survtime1to5 = -ln(U_1to5)/(`lambda_1to5lt'*exp(`g1_1to5'*exposure +`g2'*U ///
						+`g3'*exposure*U +`g4'*0 +`g5'*0)) ///
							if (death0to1==0) 
		 ...
		 qui sum death1to5 if (exposure==0)
		 local p_death1to5_exp0 = r(mean) 
         if `p_death1to5_exp0' > `target_p_death1to5_exp0'+.0001 {
            local toolow=0
            noisily di in red "I stopped at lambda_1to5==`lambda_1to5lt', p_death1to5_exp0=`p_death1to5_exp0'
         }
         else {
            noisily di in white "I did NOT stop at lambda_1to5==`lambda_1to5lt', p_death1to5_exp0=`p_death1to5_exp0'
         }
      }
   }
   local lambda_1to5`i' = `lambda_1to5lt'
}
clear
set obs 5
gen lambda_1to5=.
forvalues i=1/5 {
   replace lambda_1to5=`lambda_1to5`i'' in `i'
}
sum lambda_1to5
global lambda_1to5 = `r(mean)'
global lambda_1to5_min = `r(min)'
global lambda_1to5_max = `r(max)'



/******************************************************************************/
/***		Find baseline MORTALITY hazard for whites age 5-10	    ***/
/******************************************************************************/
clear
...
forvalues i=1/5 {
   clear
   local toolow =1
   local target_p_death5to10_exp0 = $target_p_death5to10_exp0
   *add lower bound guess here
   local lambda_5to10l = $lambda_5to10l
   quietly forvalues x = 0(.001)30 { //0(.0001)30 {
      if `toolow'==1 {
         local seed = 8675309 + `i'
		 set seed `seed'
         local lambda_5to10lt =`lambda_5to10l'+`x'
         noisily dis "***next increment***"
         noisily dis "increment = " `x'
         noisily di in green "lambda_5to10 = `lambda_5to10lt'"
         clear
		 /*Create blank data set*/
			set obs 20000 //creates blank dataset with XXXXX observations
			gen id = _n
			...
			*Generate survival time from time 2
			gen survtime5to10 = -ln(U_5to10)/(`lambda_5to10lt'*exp(`g1_5to10'*exposure +`g2'*U ///
						+`g3'*exposure*U +`g4'*0 +`g5'*0)) ///
							if (death5==0)
		 ...
		 qui sum death5to10 if (exposure==0)
		 local p_death5to10_exp0 = r(mean) 
         if `p_death5to10_exp0' > `target_p_death5to10_exp0'+.0001 {
            local toolow=0
            noisily di in red "I stopped at lambda_5to10==`lambda_5to10lt', p_death5to10_exp0=`p_death5to10_exp0'
         }
         else {
            noisily di in white "I did NOT stop at lambda_5to10==`lambda_5to10lt', p_death5to10_exp0=`p_death5to10_exp0'
         }
      }
   }
   local lambda_5to10`i' = `lambda_5to10lt'
}
clear
set obs 5
gen lambda_5to10=.
forvalues i=1/5 {
   replace lambda_5to10=`lambda_5to10`i'' in `i'
}
sum lambda_5to10
global lambda_5to10 = `r(mean)'
global lambda_5to10_min = `r(min)'
global lambda_5to10_max = `r(max)'



/******************************************************************************/
/***		Find baseline MORTALITY hazard for whites age 10-15  	    ***/
/******************************************************************************/
clear
...
forvalues i=1/5 {
   clear
   local toolow =1
   local target_p_death10to15_exp0 = $target_p_death10to15_exp0
   *add lower bound guess here
   local lambda_10to15l = $lambda_10to15l
   quietly forvalues x = 0(.001)30 { //0(.0001)30 {
      if `toolow'==1 {
         local seed = 8675309 + `i'
		 set seed `seed'
         local lambda_10to15lt =`lambda_10to15l'+`x'
         noisily dis "***next increment***"
         noisily dis "increment = " `x'
         noisily di in green "lambda_10to15 = `lambda_10to15lt'"
         clear
		 /*Create blank data set*/
			set obs 20000 //creates blank dataset with XXXXX observations
			gen id = _n
			...
			*Generate survival time from time 3
			gen survtime10to15 = -ln(U_10to15)/(`lambda_10to15lt'*exp(`g1_10to15'*exposure +`g2'*U ///
						+`g3'*exposure*U +`g4'*0 +`g5'*0)) ///
							if (death10==0)
		 ...
		 qui sum death10to15 if (exposure==0)
		 local p_death10to15_exp0 = r(mean) 
         if `p_death10to15_exp0' > `target_p_death10to15_exp0'+.0001 {
            local toolow=0
            noisily di in red "I stopped at lambda_10to15==`lambda_10to15lt', p_death10to15_exp0=`p_death10to15_exp0'
         }
         else {
            noisily di in white "I did NOT stop at lambda_10to15==`lambda_10to15lt', p_death10to15_exp0=`p_death10to15_exp0'
         }
      }
   }
   local lambda_10to15`i' = `lambda_10to15lt'
}
clear
set obs 5
gen lambda_10to15=.
forvalues i=1/5 {
   replace lambda_10to15=`lambda_10to15`i'' in `i'
}
sum lambda_10to15
global lambda_10to15 = `r(mean)'
global lambda_10to15_min = `r(min)'
global lambda_10to15_max = `r(max)'



/******************************************************************************/
/***		Find baseline MORTALITY hazard for whites age 15-20  	    ***/
/******************************************************************************/
clear
...
forvalues i=1/5 {
   clear
   local toolow =1
   local target_p_death15to20_exp0 =$target_p_death15to20_exp0
   *add lower bound guess here
   local lambda_15to20l = $lambda_15to20l
   quietly forvalues x = 0(.001)30 { //0(.0001)30 {
      if `toolow'==1 {
         local seed = 8675309 + `i'
		 set seed `seed'
         local lambda_15to20lt =`lambda_15to20l'+`x'
         noisily dis "***next increment***"
         noisily dis "increment = " `x'
         noisily di in green "lambda_15to20 = `lambda_15to20lt'"
         clear
		 /*Create blank data set*/
			set obs 20000 //creates blank dataset with XXXXX observations
			gen id = _n
			...
			*Generate survival time from time 4
			gen survtime15to20 = -ln(U_15to20)/(`lambda_15to20lt'*exp(`g1_15to20'*exposure +`g2'*U ///
						+`g3'*exposure*U +`g4'*0 +`g5'*0)) ///
							if (death15==0)
		 ...
		 qui sum death15to20 if (exposure==0)
		 local p_death15to20_exp0 = r(mean) 
         if `p_death15to20_exp0' > `target_p_death15to20_exp0'+.0001 {
            local toolow=0
            noisily di in red "I stopped at lambda_15to20==`lambda_15to20lt', p_death15to20_exp0=`p_death15to20_exp0'
         }
         else {
            noisily di in white "I did NOT stop at lambda_15to20==`lambda_15to20lt', p_death15to20_exp0=`p_death15to20_exp0'
         }
      }
   }
   local lambda_15to20`i' = `lambda_15to20lt'
}
clear
set obs 5
gen lambda_15to20=.
forvalues i=1/5 {
   replace lambda_15to20=`lambda_15to20`i'' in `i'
}
sum lambda_15to20
global lambda_15to20 = `r(mean)'
global lambda_15to20_min = `r(min)'
global lambda_15to20_max = `r(max)'




/******************************************************************************/
/***		Find baseline MORTALITY hazard for whites age 20-25	    ***/
/******************************************************************************/
clear
...
forvalues i=1/5 {
   clear
   local toolow =1
   local target_p_death20to25_exp0 = $target_p_death20to25_exp0
   *add lower bound guess here
   local lambda_20to25l = $lambda_20to25l
   quietly forvalues x = 0(.001)30 { //0(.0001)30 {
      if `toolow'==1 {
         local seed = 8675309 + `i'
		 set seed `seed'
         local lambda_20to25lt =`lambda_20to25l'+`x'
         noisily dis "***next increment***"
         noisily dis "increment = " `x'
         noisily di in green "lambda_20to25 = `lambda_20to25lt'"
         clear
		 /*Create blank data set*/
			set obs 20000 //creates blank dataset with XXXXX observations
			gen id = _n
			...
			*Generate survival time from time 5
			gen survtime20to25 = -ln(U_20to25)/(`lambda_20to25lt'*exp(`g1_20to25'*exposure +`g2'*U ///
						+`g3'*exposure*U +`g4'*0 +`g5'*0)) ///
							if (death20==0) 
		 ...
		 qui sum death20to25 if (exposure==0)
		 local p_death20to25_exp0 = r(mean) 
         if `p_death20to25_exp0' > `target_p_death20to25_exp0'+.0001 {
            local toolow=0
            noisily di in red "I stopped at lambda_20to25==`lambda_20to25lt', p_death20to25_exp0=`p_death20to25_exp0'
         }
         else {
            noisily di in white "I did NOT stop at lambda_20to25==`lambda_20to25lt', p_death20to25_exp0=`p_death20to25_exp0'
         }
      }
   }
   local lambda_20to25`i' = `lambda_20to25lt'
}
clear
set obs 5
gen lambda_20to25=.
forvalues i=1/5 {
   replace lambda_20to25=`lambda_20to25`i'' in `i'
}
sum lambda_20to25
global lambda_20to25 = `r(mean)'
global lambda_20to25_min = `r(min)'
global lambda_20to25_max = `r(max)'




/******************************************************************************/
/***		Find baseline MORTALITY hazard for whites age 25-30	    ***/
/******************************************************************************/
clear
...
forvalues i=1/5 {
   clear
   local toolow =1
   local target_p_death25to30_exp0 = $target_p_death25to30_exp0
   *add lower bound guess here
   local lambda_25to30l = $lambda_25to30l
   quietly forvalues x = 0(.001)30 { //0(.0001)30 {
      if `toolow'==1 {
         local seed = 8675309 + `i'
		 set seed `seed'
         local lambda_25to30lt =`lambda_25to30l'+`x'
         noisily dis "***next increment***"
         noisily dis "increment = " `x'
         noisily di in green "lambda_25to30 = `lambda_25to30lt'"
         clear
		 /*Create blank data set*/
			set obs 20000 //creates blank dataset with XXXXX observations
			gen id = _n
			...
			*Generate survival time from time 6
			gen survtime25to30 = -ln(U_25to30)/(`lambda_25to30lt'*exp(`g1_25to30'*exposure +`g2'*U ///
						+`g3'*exposure*U +`g4'*0 +`g5'*0)) ///
							if (death25==0)
		 ...
		 qui sum death25to30 if (exposure==0)
		 local p_death25to30_exp0 = r(mean)
         if `p_death25to30_exp0' > `target_p_death25to30_exp0'+.0001 {
            local toolow=0
            noisily di in red "I stopped at lambda_25to30==`lambda_25to30lt', p_death25to30_exp0=`p_death25to30_exp0'
         }
         else {
            noisily di in white "I did NOT stop at lambda_25to30==`lambda_25to30lt', p_death25to30_exp0=`p_death25to30_exp0'
         }
      }
   }
   local lambda_25to30`i' = `lambda_25to30lt'
}
clear
set obs 5
gen lambda_25to30=.
forvalues i=1/5 {
   replace lambda_25to30=`lambda_25to30`i'' in `i'
}
sum lambda_25to30
global lambda_25to30 = `r(mean)'
global lambda_25to30_min = `r(min)'
global lambda_25to30_max = `r(max)'



/******************************************************************************/
/***		Find baseline MORTALITY hazard for whites age 30-35	    ***/
/******************************************************************************/
clear
...
forvalues i=1/5 {
   clear
   local toolow =1
   local target_p_death30to35_exp0 = $target_p_death30to35_exp0
   *add lower bound guess here
   local lambda_30to35l = $lambda_30to35l
   quietly forvalues x = 0(.001)30 { //0(.0001)30 {
      if `toolow'==1 {
         local seed = 8675309 + `i'
		 set seed `seed'
         local lambda_30to35lt =`lambda_30to35l'+`x'
         noisily dis "***next increment***"
         noisily dis "increment = " `x'
         noisily di in green "lambda_30to35 = `lambda_30to35lt'"
         clear
		 /*Create blank data set*/
			set obs 20000 //creates blank dataset with XXXXX observations
			gen id = _n
			...
			*Generate survival time from time 7
			gen survtime30to35 = -ln(U_30to35)/(`lambda_30to35lt'*exp(`g1_30to35'*exposure +`g2'*U ///
						+`g3'*exposure*U +`g4'*0 +`g5'*0)) ///
							if (death30==0)
		 ...
		 qui sum death30to35 if (exposure==0)
		 local p_death30to35_exp0 = r(mean) 
         if `p_death30to35_exp0' > `target_p_death30to35_exp0'+.0001 {
            local toolow=0
            noisily di in red "I stopped at lambda_30to35==`lambda_30to35lt', p_death30to35_exp0=`p_death30to35_exp0'
         }
         else {
            noisily di in white "I did NOT stop at lambda_30to35==`lambda_30to35lt', p_death30to35_exp0=`p_death30to35_exp0'
         }
      }
   }
   local lambda_30to35`i' = `lambda_30to35lt'
}
clear
set obs 5
gen lambda_30to35=.
forvalues i=1/5 {
   replace lambda_30to35=`lambda_30to35`i'' in `i'
}
sum lambda_30to35
global lambda_30to35 = `r(mean)'
global lambda_30to35_min = `r(min)'
global lambda_30to35_max = `r(max)'



/******************************************************************************/
/***		Find baseline MORTALITY hazard for whites age 35-40	    ***/
/******************************************************************************/
clear
...
forvalues i=1/5 {
   clear
   local toolow =1
   local target_p_death35to40_exp0 = $target_p_death35to40_exp0
   *add lower bound guess here
   local lambda_35to40l = $lambda_35to40l
   quietly forvalues x = 0(.001)30 { //0(.0001)30 {
      if `toolow'==1 {
         local seed = 8675309 + `i'
		 set seed `seed'
         local lambda_35to40lt =`lambda_35to40l'+`x'
         noisily dis "***next increment***"
         noisily dis "increment = " `x'
         noisily di in green "lambda_35to40 = `lambda_35to40lt'"
         clear
		 /*Create blank data set*/
			set obs 20000 //creates blank dataset with XXXXX observations
			gen id = _n
			...
			*Generate survival time from time 8
			gen survtime35to40 = -ln(U_35to40)/(`lambda_35to40lt'*exp(`g1_35to40'*exposure +`g2'*U ///
						+`g3'*exposure*U +`g4'*0 +`g5'*0)) ///
							if (death35==0)
		 ...
		 qui sum death35to40 if (exposure==0)
		 local p_death35to40_exp0 = r(mean) 
         if `p_death35to40_exp0' > `target_p_death35to40_exp0'+.0001 {
            local toolow=0
            noisily di in red "I stopped at lambda_35to40==`lambda_35to40lt', p_death35to40_exp0=`p_death35to40_exp0'
         }
         else {
            noisily di in white "I did NOT stop at lambda_35to40==`lambda_35to40lt', p_death35to40_exp0=`p_death35to40_exp0'
         }
      }
   }
   local lambda_35to40`i' = `lambda_35to40lt'
}
clear
set obs 5
gen lambda_35to40=.
forvalues i=1/5 {
   replace lambda_35to40=`lambda_35to40`i'' in `i'
}
sum lambda_35to40
global lambda_35to40 = `r(mean)'
global lambda_35to40_min = `r(min)'
global lambda_35to40_max = `r(max)'



/******************************************************************************/
/***		Find baseline MORTALITY hazard for whites age 40-45	    ***/
/******************************************************************************/
clear
...
forvalues i=1/5 {
   clear
   local toolow =1
   local target_p_death40to45_exp0 = $target_p_death40to45_exp0
   *add lower bound guess here
   local lambda_40to45l = $lambda_40to45l
   quietly forvalues x = 0(.001)30 { //0(.0001)30 {
      if `toolow'==1 {
         local seed = 8675309 + `i'
		 set seed `seed'
         local lambda_40to45lt =`lambda_40to45l'+`x'
         noisily dis "***next increment***"
         noisily dis "increment = " `x'
         noisily di in green "lambda_40to45 = `lambda_40to45lt'"
         clear
		 /*Create blank data set*/
			set obs 20000 //creates blank dataset with XXXXX observations
			gen id = _n
			...
			*Generate survival time from time 9
			gen survtime40to45 = -ln(U_40to45)/(`lambda_40to45lt'*exp(`g1_40to45'*exposure +`g2'*U ///
						+`g3'*exposure*U +`g4'*0 +`g5'*0)) ///
							if (death40==0)
		 ...
		 qui sum death40to45 if (exposure==0)
		 local p_death40to45_exp0 = r(mean) 
         if `p_death40to45_exp0' > `target_p_death40to45_exp0'+.0001 {
            local toolow=0
            noisily di in red "I stopped at lambda_40to45==`lambda_40to45lt', p_death40to45_exp0=`p_death40to45_exp0'
         }
         else {
            noisily di in white "I did NOT stop at lambda_40to45==`lambda_40to45lt', p_death40to45_exp0=`p_death40to45_exp0'
         }
      }
   }
   local lambda_40to45`i' = `lambda_40to45lt'
}
clear
set obs 5
gen lambda_40to45=.
forvalues i=1/5 {
   replace lambda_40to45=`lambda_40to45`i'' in `i'
}
sum lambda_40to45
global lambda_40to45 = `r(mean)'
global lambda_40to45_min = `r(min)'
global lambda_40to45_max = `r(max)'
   ...
   *add lower bound guess here
   ...
   quietly forvalues x = 0(.001)30 { //0(.0001)30 {
      if `toolow'==1 {
		 ...
		 local p_death45to50_exp0 = r(mean) + (`pstrokedeath'*0.012) //Add in approximate number of stroke deaths
   ...
   *add lower bound guess here
   ...
   quietly forvalues x = 0(.001)30 { //0(.0001)30 {
      if `toolow'==1 {
		 ...
		 local p_death50to55_exp0 = r(mean) + (`pstrokedeath'*0.023) //Add in approximate number of stroke deaths 
   ...
   *add lower bound guess here
   ...
   quietly forvalues x = 0(.001)30 { //0(.0001)30 {
      if `toolow'==1 {
		 ...
		 local p_death55to60_exp0 = r(mean) + (`pstrokedeath'*0.042) //Add in approximate number of stroke deaths 
   ...
   *add lower bound guess here
   ...
   quietly forvalues x = 0(.001)30 { //0(.0001)30 {
      if `toolow'==1 {
		 ...
		 local p_death60to65_exp0 = r(mean) + (`pstrokedeath'*0.062) //Add in approximate number of stroke deaths 
   ...
   *add lower bound guess here
   ...
   quietly forvalues x = 0(.001)30 { //0(.0001)30 {
      if `toolow'==1 {
		 ...
		 local p_death65to70_exp0 = r(mean) + (`pstrokedeath'*0.073) //Add in approximate number of stroke deaths 
   ...
   *add lower bound guess here
   ...
   quietly forvalues x = 0(.001)30 { //0(.0001)30 {
      if `toolow'==1 {
		 ...
		 local p_death70to75_exp0 = r(mean) + (`pstrokedeath'*0.082) //Add in approximate number of stroke deaths 
   ...
   *add lower bound guess here
   ...
   quietly forvalues x = 0(.001)30 { //0(.0001)30 {
      if `toolow'==1 {
		 ...
		 local p_death75to80_exp0 = r(mean) + (`pstrokedeath'*0.084) //Add in approximate number of stroke deaths 
      ...
      if `toolow'==1 {
		...
		*Generate indicator for death before age 85
		...
		replace death85 = 1 if survage < 85
		 ...
		 local p_death80to85_exp0 = r(mean) + (`pstrokedeath'*0.071) //Add in approximate number of stroke deaths
      ...
      if `toolow'==1 {
		...
		*Generate indicator for death before age 90
		...
		replace death90 = 1 if survage < 90
		 ...
		 local p_death85to90_exp0 = r(mean) + (`pstrokedeath'*0.05) //Add in approximate number of stroke deaths
      ...
      if `toolow'==1 {
		...
		*Generate indicator for death before age 95
		...
		replace death95 = 1 if survage < 95
		 ...
		 local p_death90to95_exp0 = r(mean) + (`pstrokedeath'*0.04) //Add in approximate number of stroke deaths
...
/******************************************************************************/
capture log close
log using global_search_results_ScenarioB_2016Sept6_corr_per10000PY, replace
...
dis $lambda_0to1_min
dis $lambda_1to5_min
dis $lambda_5to10_min
dis $lambda_10to15_min
dis $lambda_15to20_min
dis $lambda_20to25_min
dis $lambda_25to30_min
dis $lambda_30to35_min
dis $lambda_35to40_min
dis $lambda_40to45_min 
